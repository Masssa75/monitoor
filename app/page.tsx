    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f23] to-[#1e1e3f] text-white flex flex-col">
      <div className="flex-1 flex flex-col justify-center p-10 max-w-md mx-auto w-full">
        <div className="space-y-16">
          ...
          <Link 
            href="/explore"
            className="block w-full bg-blue-500 bg-opacity-10 border border-blue-500 text-white py-4 font-light backdrop-blur text-center hover:bg-opacity-20 transition-all"
          >
            Start Monitoring
          </Link>
        </div>
